...
public class Utils {
	...
	public static Item getItemForTier(int tier) {
		switch(tier) {
		case 0:
			return ItemRegistries.soulContainer.get();
		case 1:
			return ItemRegistries.soulContainerTier1.get();
		case 2:
			return ItemRegistries.soulContainerTier2.get();
		case 3:
			return ItemRegistries.soulContainerTier3.get();
		case 4:
			return ItemRegistries.soulContainerTier4.get();
		case 5:
			return ItemRegistries.soulContainerTier5.get();
		default:
			return Items.AIR;
		}
	}
	...
	public static JgModelPart getPartByName(JgModel model, String name) {
