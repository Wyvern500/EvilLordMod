...
@OnlyIn(Dist.CLIENT)
public class GrimoireOfEvilModel extends Model {
	
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation(Evilord.MODID, "grimoire_of_evil_model"), "main");
	...
	public GrimoireOfEvilModel(ModelPart p_170475_) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		partdefinition.addOrReplaceChild("seam",
				...
				PartPose.rotation(0.0F, ((float) Math.PI / 2F), 0.0F));
		...
		CubeListBuilder cubelistbuilder = CubeListBuilder.create().texOffs(24, 10).addBox(0.0F, -4.0F, 0.0F, 5.0F, 8.0F,
				0.005F);
	...
	public void renderToBuffer(PoseStack p_102298_, VertexConsumer p_102299_, int p_102300_, int p_102301_,
			float p_102302_, float p_102303_, float p_102304_, float p_102305_) {
