...
public class RepetitiveAnimation extends Animation {
	...
	@Override
	public RepetitiveAnimation translate(JgModelPart part, float x, float y, float z) {
	...
	@Override
	public RepetitiveAnimation rotate(JgModelPart part, float x, float y, float z) {
